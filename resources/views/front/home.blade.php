                                            ...
                                            <div class="item item-list">
                                                <div class="product-miniature js-product-miniature first_item" data-id-product="12" data-id-product-attribute="232" itemscope itemtype="http://schema.org/Product">
                                                    <div class="thumbnail-container">
                                                        ...
                                                        <div class="product-flags discount">بيع</div>
                                                    ...
                                                    <div class="product-description">
                                                        <div class="product-groups">
                                                            ...
                                                            <div class="product-title" itemprop="name"><a href="http://demo.bestprestashoptheme.com/savemart/ar/home-appliance/12-232-nam-volutpat-justo-a-vehicula.html#/1-الحجم-ص/11-اللون_-اسود">{{$offer->title}}</a></div>
                                                            ...
                                                            <div class="product-group-price">
                                                                ...
                                                                <div class="product-price-and-shipping">
                                                                    ...
                                                                    <span itemprop="price" class="price">{{$offer->price}}</span>



                                                                    <span class="regular-price">{{$offer->price+2}}</span>
                                                        ...
                                                        <div class="product-buttons d-flex justify-content-center" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                                                            <form action="{{route('cart.add', $offer->id)}}" method="post" class="formAddToCart">
                                                                <input type="hidden" name="token" value="28add935523ef131c8432825597b9928">

                                                                <a class="add-to-cart" href="{{route('cart.add', $offer->id)}}" ><i class="novicon-cart"></i><span>أضف للسلة</span></a>
                                                            </form>
